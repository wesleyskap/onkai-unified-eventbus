...
### Added
- **Saga Orchestration**: Added `SagaContext`, `ISagaStateStore`, `SagaOrchestrator`, and `InMemorySagaStateStore` to manage distributed transactions and rollbacks.
- **Saga Extension Methods**: Added fluent `AddSaga` builder extension in `ServiceCollectionExtensions.cs`.
